...
<html lang="en">
  ...
  <body>
    ...
    <?php echo $__env->yieldContent('state'); ?>
    <?php echo $__env->yieldContent('product'); ?>
    <?php echo $__env->yieldContent('category'); ?>
    <?php echo $__env->yieldContent('userlogin'); ?>
    
  </body>
</html><?php /**PATH C:\xampp\htdocs\laravel\resources\views/layout/master2.blade.php ENDPATH**/ ?>